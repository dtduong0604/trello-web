...
import { BorderColor, Description } from '@mui/icons-material'
  ...
  return (
    <div ref={setNodeRef} style={dndKitColumStyles} {...attributes} >
      ...
      sx={{
          minWidth: '300px',
          maxWidth: '300px',
          bgcolor: (theme) => (theme.palette.mode == 'dark' ? '#333643' : '#ebedf0'),
          ml: 2,
          borderRadius: '6px',
          height: 'fit-content',
              ...
              <TextField 
                ...
                sx={{
                  ...
                  '& input': {
                    ...
                    bgcolor: (theme) => (theme.palette.node === 'dark' ? '#333643' : 'white')
                  },
