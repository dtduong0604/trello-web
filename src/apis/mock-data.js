    ...
    columns: [
      {
        ...
        cardOrderIds: ['card-id-01', 'card-id-02', 'card-id-03', 'card-id-04', 'card-id-05', 'card-id-07', 'card-id-06'],
        cards: [
          {
            _id: 'card-id-01',
            boardId: 'board-id-01',
            ...
            cover: 'https://newocean.edu.vn/wp-content/uploads/2025/01/chinh-tri-vuong-quoc-anh.jpg',
